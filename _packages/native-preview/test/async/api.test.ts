...
import { visitEachChild } from "@loongdotjs/typescript-native-preview/unstable/ast/visitor";
import {
    API,
...
} from "@loongdotjs/typescript-native-preview/unstable/async"; // @sync: } from "@loongdotjs/typescript-native-preview/unstable/sync";
import { createVirtualFileSystem } from "@loongdotjs/typescript-native-preview/unstable/fs";
import type { FileSystem } from "@loongdotjs/typescript-native-preview/unstable/fs";
...
`,
        ...
        try {
            ...
            let callNode: import("@loongdotjs/typescript-native-preview/unstable/ast").CallExpression | undefined;
            sourceFile.forEachChild(function visit(node) {
...
`,
        ...
        try {
            ...
            assert.ok(callStmt);
            let numLiteral: import("@loongdotjs/typescript-native-preview/unstable/ast").Expression | undefined;
...
`,
        ...
        try {
            ...
            let firstReturnX: import("@loongdotjs/typescript-native-preview/unstable/ast").Node | undefined;
...
`,
        ...
        try {
            ...
            let shorthandNode: import("@loongdotjs/typescript-native-preview/unstable/ast").Node | undefined;
            sourceFile.forEachChild(function visit(node) {
...
describe("Checker - isContextSensitive", () => {
    test("arrow function with no type annotation is context sensitive", async () => {
        ...
        try {
            ...
            let arrowFn: import("@loongdotjs/typescript-native-preview/unstable/ast").Node | undefined;
            sourceFile.forEachChild(function visit(node) {
...
`,
    ...
    test("printNode with terminateUnterminatedLiterals option", async () => {
        ...
        try {
            ...
            let regexNode: import("@loongdotjs/typescript-native-preview/unstable/ast").Node | undefined;
            sourceFile.forEachChild(function visit(node) {
...
describe("modifierFlags", () => {
    test("export async function has Export | Async flags", async () => {
        ...
        try {
            ...
            let fnNode: import("@loongdotjs/typescript-native-preview/unstable/ast").FunctionDeclaration | undefined;
            sourceFile.forEachChild(function visit(node) {
...
describe("Checker - getResolvedSymbol", () => {
    test("resolves variable reference to its declaration symbol", async () => {
        ...
        try {
            ...
            let refNode: import("@loongdotjs/typescript-native-preview/unstable/ast").Identifier | undefined;
            sourceFile.forEachChild(function visit(node) {
...
describe("VariableDeclarationList - BlockScoped flags", () => {
    test("let declaration has Let flag", async () => {
        ...
        try {
            ...
            let declList: import("@loongdotjs/typescript-native-preview/unstable/ast").Node | undefined;
            sourceFile.forEachChild(function visit(node) {
...
test("TypeOperator operator kind", async () => {
    ...
    try {
        ...
        const sourceFile = await project.program.getSourceFile("/src/index.ts");
        assert(sourceFile);
        const param = (sourceFile.statements[0] as import("@loongdotjs/typescript-native-preview/unstable/ast").FunctionDeclaration).parameters[0];
        assert(param);
        const type = param.type as import("@loongdotjs/typescript-native-preview/unstable/ast").TypeOperatorNode;
        assert(type);
...
test("SpreadAssignment roundtrip", async () => {
    ...
    try {
        ...
        const sourceFile = await project.program.getSourceFile("/src/index.ts");
        assert(sourceFile);
        const stmt = sourceFile.statements[0] as import("@loongdotjs/typescript-native-preview/unstable/ast").VariableStatement;
        const object = stmt.declarationList.declarations[0].initializer as import("@loongdotjs/typescript-native-preview/unstable/ast").ObjectLiteralExpression;
        const assignment = object.properties[0] as import("@loongdotjs/typescript-native-preview/unstable/ast").SpreadAssignment;
        assert(assignment);
...
test("VariableDeclarationList const flag clone", async () => {
    ...
    try {
        ...
        {
            const stmt = cloned.statements[0] as import("@loongdotjs/typescript-native-preview/unstable/ast").VariableStatement;
            const list = stmt.declarationList;
            assert(list.flags & NodeFlags.Const);
        }
